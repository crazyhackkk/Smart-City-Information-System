...
public class sub_admin_page extends javax.swing.JFrame {
    ...
    private void superbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_superbtnActionPerformed
        ...
        try {        	
             ...
             String sql = "INSERT INTO allinfo values('"+z+"','"+a+"','"+b+"','"+c+"','"+d+"')";         
...
//        sa.dataentry(ob);
    ...
    private void sinfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sinfoActionPerformed
        // TODO add your handling code here:
        local_student ls= new local_student("alam","0179162664","Diu","female","35-1111");
        sub_admin sa = new sub_admin(null,null,null,null);
    ...
    private void tviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tviewActionPerformed
        // TODO add your handling code here:
        foreign_tourist ft= new foreign_tourist("Aaftab","0179162664","bbbb","usa","male","35-2037");
        sub_admin sa = new sub_admin(null,null,null,null);
