...
public class local_student_page extends javax.swing.JFrame {
     ...
     public void show_Info(String sql)
    {
        try {
        	...
        	con.rm=rs.getMetaData();
        	DefaultTableModel model=(DefaultTableModel) table.getModel();
        	int cols=con.rm.getColumnCount();
        	...
        	System.out.println("Error hai bs ");
...
//        });
        ...
        scrollPane.setBounds(100,70,500,350);
        
        JLabel lblNewLabel = new JLabel("  Info_Type            ID                    Name                   PhoneNo                Location");
        lblNewLabel.setBackground(new Color(255, 255, 255));
        lblNewLabel.setFont(new Font("Lucida Handwriting", Font.ITALIC, 14));
        ...
        panel3Layout.setHorizontalGroup(
        	panel3Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(panel3Layout.createSequentialGroup()
        			...
        			.addComponent(Ebtn)
        			.addGap(18)
        			.addComponent(Hbtn, GroupLayout.PREFERRED_SIZE, 92, GroupLayout.PREFERRED_SIZE)
        		...
        		.addGroup(panel3Layout.createSequentialGroup()
        			...
        			.addComponent(button1, GroupLayout.PREFERRED_SIZE, 261, GroupLayout.PREFERRED_SIZE)
        			.addGap(40)
        			.addComponent(clearData, GroupLayout.PREFERRED_SIZE, 149, GroupLayout.PREFERRED_SIZE)
        			.addGap(121))
        		.addGroup(panel3Layout.createSequentialGroup()
        			.addGap(50)
        			.addGroup(panel3Layout.createParallelGroup(Alignment.LEADING, false)
        				.addComponent(lblNewLabel, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        				.addComponent(table, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 692, Short.MAX_VALUE))
        	...
        	panel3Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(panel3Layout.createSequentialGroup()
        			...
        			.addGroup(panel3Layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addComponent(clearData, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE))
        			.addGap(18)
...
//    }//GEN-LAST:event_clearDataActionPerformed
    ...
    private void tview1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tview1ActionPerformed
        // TODO add your handling code here:
        foreign_businessman fb= new foreign_businessman("Aaftab","0179162664","dcl","aaa","usa","male","35-2037");
